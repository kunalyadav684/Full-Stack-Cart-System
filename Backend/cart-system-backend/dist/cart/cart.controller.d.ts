...
export declare class CartController {
    ...
    add(dto: AddItemDto, userId: string): Promise<import("mongoose").Document<unknown, {}, import("./interfaces/cart.interface").Cart, {}> & import("./interfaces/cart.interface").Cart & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    }>;
    update(userId: string, productId: string, quantity: number): Promise<(import("mongoose").Document<unknown, {}, import("./interfaces/cart.interface").Cart, {}> & import("./interfaces/cart.interface").Cart & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    }) | undefined>;
